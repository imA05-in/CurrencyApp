...
export default function ConverterWrapper() {
  ...
  useEffect(()=>{
    ...
    const result = (toCurr/fromCurr)*fromAmount
    setToAmount(result)
  ...
  return (
    <div className=" ConverterWrapper w-full p-3 bg-neutral-700 mt-2">
      ...
      <div className="converter-wrapper flex flex-col md:flex-row items-center w-full">
        ...
        <div className="bg-neutral-600 border-neutral-500 p-2 my-1 rounded" onClick={()=>handleSwap()}>
